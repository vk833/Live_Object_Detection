  ...
  <div class="container">
    ...
    <div class="cover">
      <div class="front">
        ...
        <div class="text">
          <span class="text-1"><img src="lp.png" style="position:absolute; top:0px; left:0px; background-img:cover;"></span>
...
$a=$_POST['mail'];	
$b=$_POST['pwd'];
$q=mysqli_query($con,"select * from profile where Email='$a' and Password='$b'");
$c=mysqli_num_rows($q);
if($c>0)
{
	while($r=mysqli_fetch_assoc($q))
	{
		$_SESSION['uid']=$r['Firstname'];
	}
...
if(isset($_POST['signup']))
{
	...
	$q= mysqli_query($con,"insert into profile values('$a','$b','$c')");
}
?>
</body>
</html>
