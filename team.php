        ...
        <nav class="navbar navbar-expand-lg custom_nav-container ">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <li class="nav-item">
                ...
                <a class="nav-link" href="detuction/detuct.php">Detect</a>
              </li>
			  <li class="nav-item">
			  
                <a class="nav-link" href="detuction/detuct1.php">Video Detect</a>
              </li>
			<?php
      ...
      <div class="team_container">
        <div class="row">
          <div class="col-lg-4 col-sm-6">
            <div class="box ">
              <div class="img-box">
                <img src="images/varun1.jpg" class="img1" alt="Harshit Image" style="height:150px; width:150px;">
              </div>
          ...
          <div class="col-lg-4 col-sm-6">
            <div class="box ">
              <div class="img-box">
                <img src="images/suyash.jpg" class="img1" alt="Vishal image" style="height:150px; width:150px;">
              </div>
              <div class="detail-box">
                <h5>
                  Suyash Saini
          ...
          <div class="col-lg-4 col-sm-6">
            <div class="box ">
              <div class="img-box">
                <img src="images/rishabh.png" class="img1" alt="Yuvraj Image" style="height:150px; width:150px;">
              </div>
              <div class="detail-box">
                <h5>
                  Rishabh Saklani
